...
export default function CreatePage() {
	...
	const createPortalSig = async () => {
		try {
			...
			console.log(data)
			// toast({
			// 	title: "Rumble created",
			// 	description: `Rumble successfuly created !`,
			// 	status: "success",
			// 	duration: 5000,
			// 	isClosable: true
			// })
		...
		<Layout>
			...
			>
				<Card className={classes.create_card}>
					...
					<CardContent>
						<p>
							Please enter the number of confirmations required
							for every future transaction of this wallet.
						</p>
						...
						<p className={classes.small_text}>
							Note : there should be at least two owners minimum,
							and two confirmation required minimum.
						</p>
